...
### ออเดอร์ — มุมมองครัว vs บิลรวมโต๊ะ (orders.tsx)

หน้าออเดอร์มี segment control สลับ 2 มุมมอง:

**ครัว (kitchen):**
- แสดงออเดอร์แต่ละรายการ เรียงตามเวลา
- ออเดอร์ใหม่มีป้าย "ใหม่!" + ขอบแดง (auto-clear 8 วินาที)
- กดเพื่อเปลี่ยนสถานะ: รับออเดอร์ → พร้อมเสิร์ฟ

**บิลรวมโต๊ะ (bills):**
- Group orders by `table_number` → แสดงเป็น bill card ต่อโต๊ะ
- แต่ละ bill แสดงทุก order + items + สถานะ
- ยกเลิกรายเมนู: ปุ่ม X ข้างแต่ละ item → `cancelOrderItem()`
- ยกเลิกทั้ง order: ปุ่มถังขยะ → `cancelOrder()`
