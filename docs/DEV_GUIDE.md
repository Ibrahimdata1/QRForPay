...
| **พนักงานยกเลิกต่อรายการได้** | `order_items.item_status = 'cancelled'` ผ่านแท็บ "โต๊ะ" |
...
```
Production (Vercel):
https://dist-two-rose-32.vercel.app/customer?shop=<shopId>&table=<tableNumber>
...
**URL Production**: `https://dist-two-rose-32.vercel.app`
